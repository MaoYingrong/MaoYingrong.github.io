...
<div class="projects-grid">
  ...
  <article class="project">
    <img src="/images/projects/unwritten-code.png" alt="thumbnail">
    <div>
  ...
  <article class="project">
    <img src="/images/projects/conference-sim.png" alt="thumbnail">
    <div>
...
.project { display: grid; grid-template-columns: 240px 1fr; gap: 24px; align-items: start; padding: 14px; border-radius: 14px; box-shadow: 0 2px 18px rgba(0,0,0,.06); background:#fff; }
...
.buttons .btn { display: inline-block; padding: 6px 10px; border: 1px solid #222; border-radius: 6px; text-decoration: none; font-size: 0.85rem; margin-right: 8px; }
